...
\begin{enumerate}
\item		The domain of $f$ is $\begin{prompt}\answer{(-\infty,-1)\cup(-1,1)\cup(1,\infty)}\end{prompt}$.
\item		$f$ has a critical point(s) at $x\begin{prompt} = \answer{0}\end{prompt}$.
\item		$f$ is decreasing on $\begin{prompt}\answer{(-\infty,-1)\cup(-1,0)}\end{prompt}$.
\item		$f$ is increasing on $\begin{prompt}\answer{(0,1)\cup(1,\infty)}\end{prompt}$.
\item		At $x=0$, $f$ has 
\begin{prompt}
